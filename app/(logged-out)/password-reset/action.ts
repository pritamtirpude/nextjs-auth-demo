...
export const passwordReset = async (emailAddress: string) => {
  ...
  await mailer.sendMail({
    ...
    to: emailAddress,
    html: `Hey, ${emailAddress}! You requested to reset your password. Here's your password reset link. This link will expire in 1 hour: <a href="${resetLink}">${resetLink}</a>`,
  });
};
